...
class MainProgram:
    def __init__(self, master):
        ...
        self.data = DataFileManager('data.json', 'key.key').get_data()
    ...
    def changeParentPass(self):
        ...
        entry1 = tk.Entry()
        button1 = tk.Button (self.master,text = "Confirm" , command=lambda: print("Confirm")) #to DO
        button2 =  tk.Button (self.master, text = "Cancel" , command=lambda: [label1.place_forget(),entry1.place_forget(),button1.place_forget(),button2.place_forget(),self.changePass()])
    ...
    def changePass(self):
        button1 = tk.Button(self.master,text = "Parent" , command=lambda:[button1.place_forget(),button2.place_forget(),button3.place_forget(),self.changeParentPass()])
        button2 = tk.Button(self.master,text = "Child" , command=lambda:[button1.place_forget(),button2.place_forget(),button3.place_forget(),self.changeChildPass()])
        button3 = tk.Button(self.master,text = "Cancel" , command=lambda:[button1.place_forget(),button2.place_forget(),button3.place_forget(),self.main_menu()]) 
    ...
    def cancel_add(self,selectDay):
        ...
        button1 = tk.Button(self.master,text = "Add" , command=lambda: [button1.place_forget(),button2.place_forget(),button3.place_forget(),self.add(my_listbox,selectDay)])
        button2 = tk.Button(self.master,text = "Delete" , command=lambda: self.deleteTime(my_listbox,selectDay))
        button3 = tk.Button(self.master,text = "Cancel" , command=lambda: [my_listbox.place_forget(),button1.place_forget(),button2.place_forget(),button3.place_forget(),self.Edit()])
        button1.place(x= 200,y =200)
        button2.place(x= 275,y=200)
        button3.place(x= 350,y=200)
    ...
    def addTime(self,my_listbox,selectDay,entry1,entry2,entry3,entry4,entry5):
        ...
        if str != "":
            #to DO
            self.data[selectDay].append(str)
            self.data[selectDay].sort()
            #------------------
            self.data.save_data()
            my_listbox.insert(tk.END,str)
    ...
    def add(self,my_listbox,selectDay):
        ...
        button = tk.Button(self.master,text = "Add" , command=lambda: self.addTime(my_listbox,selectDay,entry1,entry2,entry3,entry4,entry5))
    ...
    def Edit(self):
        ...
        for item in my_list:
            my_listbox.insert(tk.END,item)
        button = tk.Button(self.master,text = "Select" , command=lambda: [self.select_menu(selectDay = my_listbox.get(tk.ANCHOR)),button.place_forget(),button2.place_forget(),my_listbox.place_forget()] )
        button2 = tk.Button(self.master,text = "Cancel" , command=lambda:[my_listbox.place_forget(),button.place_forget(),button2.place_forget(),self.main_menu()])
        button.place(x = 210, y = 200)
        button2.place(x = 300, y = 200)

    def main_menu(self):        
        button1 = tk.Button(self.master,text = "Change password", command = lambda:[button1.place_forget(),button2.place_forget(),self.changePass()])
        button2 = tk.Button(self.master,text = "Edit" , command=lambda:[button1.place_forget(),button2.place_forget(),self.Edit()])
